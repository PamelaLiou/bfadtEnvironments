...
Create a hyperlink Choose-Your-Own-Adventure story using linked HTML pages. 
The prompt: A character caught between two worlds, paradigm shift, or transformative event. 
